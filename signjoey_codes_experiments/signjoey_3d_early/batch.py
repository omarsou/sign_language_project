...
class Batch:
    ...
    def __init__(
        ...
        self.keypoints, self.keypoints_lengths = torch_batch.keypoints
        ...
        self.keypoints_mask = (self.keypoints != torch.zeros(keypoints_dim))[..., 0].unsqueeze(1)
    ...
    def _make_cuda(self):
        ...
        self.keypoints_mask = self.keypoints_mask.cuda()
    ...
    def sort_by_sgn_lengths(self):
        ...
        self.keypoints = self.keypoints[perm_index]
        self.keypoints_mask = self.keypoints_mask[perm_index]
        self.keypoints_lengths = self.keypoints_lengths[perm_index]
