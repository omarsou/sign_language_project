...
def load_data(data_cfg: dict) -> (Dataset, Dataset, Dataset, Vocabulary, Vocabulary):
    ...
    pad_feature_size_features = data_cfg["feature_size_cnn"]
    ...
    features_field = data.Field(
        ...
        include_lengths=True,
        postprocessing=stack_features,
        pad_token=torch.zeros((pad_feature_size_features,)),
    )
    ...
    train_data = SignTranslationDataset(
        path=train_paths,
        fields=(sequence_field, signer_field, sgn_field, features_field, gls_field, txt_field),
