...
class Batch:
    ...
    def __init__(
        ...
        self.features, self.features_lengths = torch_batch.features
    ...
    def sort_by_sgn_lengths(self):
        ...
        self.features = self.features[perm_index]
        self.features_mask = self.features_mask[perm_index]
        self.features_lengths = self.features_lengths[perm_index]
